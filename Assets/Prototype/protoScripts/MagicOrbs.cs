...
public class MagicOrbs : MonoBehaviour
{
    ...
    {
        if (Input.GetKeyDown(KeyCode.Alpha1)) UpdateMagicElements(1);
        else if (Input.GetKeyDown(KeyCode.Alpha2)) UpdateMagicElements(2);
        else if (Input.GetKeyDown(KeyCode.Alpha3)) UpdateMagicElements(3);
    }
